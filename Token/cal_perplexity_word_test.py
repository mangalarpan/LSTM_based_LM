...
f = codecs.open("gut_test_word.txt", encoding='latin')
raw_data =f.read()
f.close()
...
pickle_out = open("emb_mat_test.pickle","wb")
pickle.dump(embedding_matrix, pickle_out)
pickle_out.close()
pickle_out = open("per_word_x_test.pickle","wb")
pickle.dump(x, pickle_out)
pickle_out.close()
pickle_out = open("per_word_y_test.pickle","wb")
